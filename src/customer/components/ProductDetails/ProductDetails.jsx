...
<section className='grid grid-cols-1 lg:grid-cols-2 gap-y-10 px-4 pt-10'>
 ...
 <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2">
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Van Heusen</h1>
            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>
                Men Regular Fit Printed Spread Collar Party Shirt</h1>
          </div>
            ...
            <div className='border p-5'>
                    ...
                    <Grid item xs={5}>
                      ...
                      <div className='flex items-center space-x-3'>
                        ...
                        <p className='opacity-60'>54353 Ratings</p>
                      </div>
